...
export const BlueprintSchema = z.object({
    ...
    imageAssets: z.array(ImageAssetSchema).optional().describe('Real image assets the application genuinely needs (logos, hero images, illustrations). Declared here so they are generated by dedicated image models before the first build and referenced as real files. Omit decorative chrome that CSS/SVG can produce. Keep the list tight (typically 0-5).'),
