...
- Icons: lucide-react removed all brand/social icons (instagram, facebook, twitter, linkedin, youtube, github, etc.) — referencing them renders a blank; build social links with inline SVG brand marks instead.
