...
CREATE UNIQUE INDEX `cloudflare_accounts_user_account_idx` ON `cloudflare_accounts` (`user_id`,`account_id`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `ai_gateways_gateway_id_idx` ON `ai_gateways` (`cloudflare_account_id`,`gateway_id`);
