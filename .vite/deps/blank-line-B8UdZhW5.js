...
*   Start state.
*/
function factorySpace(effects, ok$1, type, max) {
...
* @type {Tokenizer}
*/
function tokenizeBlankLine(effects, ok$1, nok) {
	return start;
	/**
	* Start of blank line.
	*
	...
	*/
	function after(code) {
		return code === codes.eof || markdownLineEnding(code) ? ok$1(code) : nok(code);
	}
}

//#endregion
export { asciiAlpha, asciiAlphanumeric, asciiAtext, asciiControl, asciiDigit, asciiHexDigit, asciiPunctuation, blankLine, classifyCharacter, codes, combineExtensions, constants, factorySpace, markdownLineEnding, markdownLineEndingOrSpace, markdownSpace, normalizeIdentifier, ok, push, resolveAll, splice, toString, types, unicodePunctuation, unicodeWhitespace, unreachable, values };
//# sourceMappingURL=blank-line-B8UdZhW5.js.map